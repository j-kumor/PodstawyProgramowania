...
# Loop through each product, calculate the total value for that product, and add it to the total value
for i in range(len(product_prices)):
    total_value += product_prices[i] * product_quantities[i]

print("Total value of all goods in the store: {:.2f} currency units".format(total_value))
